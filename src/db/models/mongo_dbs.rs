...
#[sqlx_gen(kind = "table", schema = "main", table = "mongo_dbs")]
pub struct MongoDb {
    #[sqlx_gen(primary_key, sql_type = "mongo_dbs_id_enum")]
    ...
    #[sqlx_gen(sql_type = "TEXT", column_default = "'mongo:8'")]
    ...
    pub replicas: i64,
    #[sqlx_gen(sql_type = "mongo_dbs_app_status_enum", column_default = "'IDLE'")]
