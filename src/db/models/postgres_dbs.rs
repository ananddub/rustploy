...
#[sqlx_gen(kind = "table", schema = "main", table = "postgres_dbs")]
pub struct PostgresDb {
    #[sqlx_gen(primary_key, sql_type = "postgres_dbs_id_enum")]
    ...
    #[sqlx_gen(sql_type = "TEXT", column_default = "'postgres:18'")]
    ...
    pub replicas: i64,
    #[sqlx_gen(sql_type = "postgres_dbs_app_status_enum", column_default = "'IDLE'")]
