...
#[sqlx_gen(kind = "table", schema = "main", table = "mysql_dbs")]
pub struct MysqlDb {
    #[sqlx_gen(primary_key, sql_type = "mysql_dbs_id_enum")]
    ...
    #[sqlx_gen(sql_type = "TEXT", column_default = "'mysql:9'")]
    ...
    pub replicas: i64,
    #[sqlx_gen(sql_type = "mysql_dbs_app_status_enum", column_default = "'IDLE'")]
