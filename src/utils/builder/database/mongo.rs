...
pub async fn build_mongo_stack(
    ...
    resolved_env.insert("MONGO_INITDB_ROOT_USERNAME".to_string(), db.database_user.clone());
    resolved_env.insert("MONGO_INITDB_ROOT_PASSWORD".to_string(), db.database_password.clone());
