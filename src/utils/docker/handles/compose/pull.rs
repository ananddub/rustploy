...
pub struct ComposePullBuilder<'a> {
...
impl<'a> ComposePullBuilder<'a> {
    pub(crate) fn new(cli: &'a DockerCli) -> Self {
        Self {
            cli,
            args: ArgBuilder::cmd(&["compose", "pull"]),
        }
    }
    ...
    pub fn ignore_pull_failures(mut self) -> Self {
        self.args.flag("--ignore-pull-failures");
        self
    }
    pub fn parallel(mut self) -> Self {
        self.args.flag("--parallel");
        self
    }
...
impl crate::utils::exec::script::IntoCommand for ComposePullBuilder<'_> {
