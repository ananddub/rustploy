...
pub struct ComposeRunBuilder<'a> {
...
impl<'a> ComposeRunBuilder<'a> {
    pub(crate) fn new(cli: &'a DockerCli, service: impl Into<String>) -> Self {
        Self {
            cli,
            args: ArgBuilder::cmd(&["compose", "run"]),
    ...
    pub fn entrypoint(mut self, e: impl Into<String>) -> Self {
        self.args.pair("--entrypoint", e.into());
        self
    }
    ...
    pub fn publish(mut self, p: impl Into<String>) -> Self {
        self.args.pair("--publish", p.into());
        self
    }
    ...
    pub fn service_ports(mut self) -> Self {
        self.args.flag("--service-ports");
        self
    }
...
impl crate::utils::exec::script::IntoCommand for ComposeRunBuilder<'_> {
